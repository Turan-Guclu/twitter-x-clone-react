        ...
        <Popover className="relative outline-none">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box shadow-white rounded-xl overflow-hidden">
                ...
                <Disclosure>
                    ...
                    {({open})=>(
                        <>
                    <Disclosure.Button className="h-[52px] justify-between w-full flex items-center px-4 font-bold hover:bg-[#eff3f41a] transition-colors">
                     İçerik Üreticisi Stüdyosu
                        <svg className={classNames(open && 'rotate-180 text-[#1d9bf0]')} viewBox="0 0 24 24" width={18.75} height={18.75}>
                                <path
                                    fill="currentColor"
